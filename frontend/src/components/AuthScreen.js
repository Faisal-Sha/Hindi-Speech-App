      ...
      if (isLogin) {
        ...
        if (error) {
          ...
          if (response.ok) {
            ...
            // Account doesn't exist - this might be first login after email confirmation
            const pendingAccountName = localStorage.getItem('pendingAccountName');
            const pendingEmail = localStorage.getItem('pendingEmail');
            
            if (pendingAccountName && pendingEmail === formData.email) {
              ...
              if (createResponse.ok) {
                ...
                localStorage.removeItem('pendingAccountName');
                localStorage.removeItem('pendingEmail');
                
                onAuthSuccess(accountData.account, token);
              } else {
                setError(accountData.message || 'Failed to create account');
              }
            } else {
        ...
        if (error) {
          ...
          // Store the account name temporarily for after confirmation
          localStorage.setItem('pendingAccountName', formData.accountName);
          localStorage.setItem('pendingEmail', formData.email);
          
          setError('✅ Account created! Please check your email to confirm your address, then login.');
        }
      }
